...
public class CallServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req,
        ...
        out.println("<html>");
        out.println("<title>Dial and Call</title>" +
              ...
              "<body bgcolor='#8dc6ff'><h1 align='center' style='color:#2f2f2f'>RADIO CALL</h1>" +
              "<form method='post'>" +
              "<div align='center'><input style='font-size:24px' type='text' name='phone_number' id='phone_number'/><br/>" +
    ...
    protected void doPost(HttpServletRequest req,
        ...
        out.println("<html>" +
                ...
                "<h1 align='center'>Dialling " + phoneNumber + " ... </h1>" +
                "</body>" +
                "</html>");
    }
